...
public class Tree
{
   ...
   */  
   ...
   {
      // Do DFS everywhere and then compare the heights
      // Whichever is the largest gets returned
      // numAnc is the same as the height at a certain node
      // Let's loop through every node in the tree and see
      // who has the most ancestors
      if(n.children.size() != 0)
      {
         int maxHeight = numAnc(n);
         for(Node child : n.children)
         {
